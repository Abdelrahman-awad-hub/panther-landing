...
export function SocialDock() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-24 end-4 z-50 grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-xl ring-1 ring-black/5 transition-transform duration-200 hover:scale-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 sm:bottom-6 sm:end-6 sm:h-14 sm:w-14"
    >
