...
export function TrustedBrandsStrip() {
  ...
  return (
    <section className="border-b border-zinc-100 bg-white py-8" aria-label={t('title')}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-5 sm:gap-x-12">
          {logoClients.map((client) => (
            <div key={client.id} className="relative h-11 w-20 opacity-70 grayscale transition hover:opacity-100 hover:grayscale-0 sm:w-24">
